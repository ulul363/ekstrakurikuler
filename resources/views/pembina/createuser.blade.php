...
@section('content')
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Buat User Pembina</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{ route('pembina.index') }}">Pembina</a></li>
                            <li class="breadcrumb-item">Buat User Pembina</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">Buat User Pembina</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('pembina.storeuser') }}" role="form">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
