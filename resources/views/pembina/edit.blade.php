                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <select name="ekstrakurikuler_id" class="form-control"
                                                    ...
                                                    @foreach ($ekstrakurikuler as $item)
                                                        <option value="{{ $item->id_ekstrakurikuler }}"
                                                            {{ $pembina->ekstrakurikuler_id == $item->id_ekstrakurikuler ? 'selected' : '' }}>
                                                            {{ $item->nama }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="alamat" class="form-control" id="alamat"
                                                    value="{{ $pembina->alamat }}" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="jk">Jenis Kelamin</label>
                                                <select name="jk" class="form-control" id="jk" required>
                                                    <option value="L" {{ $pembina->jk == 'L' ? 'selected' : '' }}>
                                                        Laki-Laki</option>
                                                    <option value="P" {{ $pembina->jk == 'P' ? 'selected' : '' }}>
                                                        Perempuan</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
