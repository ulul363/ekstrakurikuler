...
<body>
    ...
    <div class="auth-wrapper">
        <div class="auth-content text-center">
            <img src="{{ asset('assets/images/MAN_Demak.png') }}" alt="" class="img-fluid mb-4">
            <div class="card borderless">
                <div class="row align-items-center ">
                    <div class="col-md-12">
                        <div class="card-body">
                            <h4 class="mb-3 f-w-400">Siextra</h4>
                            <hr>
                            ...
                            <p class="mb-0 text-muted">Tidak memiliki akun? <a href="{{ route('register') }}" class="f-w-400">Daftar</a></p>
                        </div>
                    </div>
                </div>
            </div>
